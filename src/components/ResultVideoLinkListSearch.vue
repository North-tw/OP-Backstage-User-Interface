      ...
      <div class="row py-3">
        ...
        >
          <div>
              ...
              <div v-else-if="inputMap[field].input === 'time'">
                <div class="col-12 position-relative">
                  <FlatPickr     
                    :id="field"
                    v-model="state[field]"
...
export default {
  name: 'ResultVideoLinkListSearch',
  components: {
    AppInput, FlatPickr
  },
  props: {
  ...
  setup (props, { emit }) {
    ...
    const state = ref({
      ...
      dateTime: props.searchState.dateTime ?? null
    })
    ...
    const styleMap = {
      ...
      dateTime: 'col-12 col-sm-6 col-md-6'
    }
